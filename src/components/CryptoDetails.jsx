  ...
  return (
    <Col className='coin-detail-container'>
      <Col className='coin-heading-container'>
        ...
        <p>
          {data?.data?.coin.name} live price in USD. View statistics, market cap and supply
        </p>
      </Col>
      ...
      <Col className='stats-container'>
        ...
        <Col className='other-stats-info'>
          <Col className='coin-value-statistics-heading'>
            ...
            <p>
              An overview showing the stats of all Crptocurrencies 
            </p>
          </Col>
        ...
        <Col className='coin-links'>
          <Title level={3} className='coin-detailes-heading'>
            ...
            <Row className='coin-link' key={item.name}>
              <Title level={5} className='links-name'>
                {item.type}
              </Title>
